import BasicLineGraphExample from './examples/BasicLineGraph?dev-site-example';
import SplineGraphExample from './examples/SplineGraph?dev-site-example';
...
- ### `regions`
    ...
    | axis          | string | yes      | "y"                                                                                              | Defines which axis it represents  |
...
Nature of line that needs to be drawn (Linear or Cardinal). Valid values are:
- `Carbon.helpers.LINE_TYPE.LINEAR`
- `Carbon.helpers.LINE_TYPE.SPLINE`
