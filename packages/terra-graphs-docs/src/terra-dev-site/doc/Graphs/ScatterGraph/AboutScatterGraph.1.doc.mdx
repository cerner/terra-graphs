...
| values        | array of objects | yes      | -                    | Refer to [Values](#values).                                                                                          |
...
| legendOptions | object           | no       | `undefined`          | Refer to [LegendOptions](#legendOptions).                                                                            |
| onClick       | function         | no       | `undefined`          | Function to execute upon clicking a datapoint, such as, to display a popup.                                          |
| regions       | array of objects | no       | `[]`                 | Refer to [Regions](#regions).                                                                                        |
