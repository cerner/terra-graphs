import Timeline from '@cerner/terra-graphs-docs/lib/terra-dev-site/doc/example/Graphs-Carbon/Timeline/BasicTimeline/AxisWithNoTickValues?dev-site-example';
