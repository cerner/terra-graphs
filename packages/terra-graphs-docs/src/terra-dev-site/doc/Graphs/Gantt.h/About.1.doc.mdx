...
| dateline               | array   | no       | `[ ]`                                          | See [Dateline](../GettingStarted.a/GraphCore/Documentation/Dateline).                                   |
| legendPadding          | object  | no       | `{ top: 4, bottom: 4, left: 8, right: 8 }`     | See [legendPadding](#legendpadding).                                                                    |
| locale                 | object  | no       | `LOCALE.en_US`                                 | Locale object for X-Axis tick values. See [Locale](../GettingStarted.a/GraphCore/Documentation/Locale). |
| padding                | object  | no       | `{ top: 10, bottom: 10, left: 30, right: 50 }` | See [Padding](../GettingStarted.a/GraphCore/Documentation/Padding).                                     |
| pan                    | object  | no       | `{enabled: false}`                             | See [Panning](../GettingStarted.a/GraphCore/Documentation/Panning).                                     |
...
**type:** object  
  ...
  | ticks         | objects | no       | See [Ticks](../GettingStarted.a/GraphCore/Documentation/Ticks) (x-axis only). |
