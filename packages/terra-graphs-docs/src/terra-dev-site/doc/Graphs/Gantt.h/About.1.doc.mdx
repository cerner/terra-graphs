...
| dateline               | array   | no       | `[ ]`                                          | See [Dateline](../GettingStarted/GraphCore/Documentation/Dateline).                                     |
| legendPadding          | object  | no       | `{ top: 4, bottom: 4, left: 8, right: 8 }`     | See [legendPadding](#legendpadding).                                                                    |
| locale                 | object  | no       | `LOCALE.en_US`                                 | Locale object for X-Axis tick values. See [Locale](../getting-started/graph-core/documentation/Locale). |
| padding                | object  | no       | `{ top: 10, bottom: 10, left: 30, right: 50 }` | See [Padding](../getting-started/graph-core/documentation/Padding).                                     |
| pan                    | object  | no       | `{enabled: false}`                             | See [Panning](../getting-started/graph-core/documentation/Panning).                                     |
...
**type:** object  
  ...
  | ticks         | objects | no       | See [Ticks](../getting-started/graph-core/documentation/Ticks) (x-axis only). |
