...
| dateline               | array    | []                                             | Refer [Dateline](./Dateline)                                                                                                                                                    |
...
| padding                | object   | `{ top: 10, bottom: 10, left: 30, right: 50 }` | Refer [Padding](https://github.com/cerner/terra-graphs/blob/main/packages/terra-graphs-docs/docs/controls/Padding.md)                                                                                                                                                     |
| pan                    | object   | {}                                             | Refer [Panning](https://github.com/cerner/terra-graphs/blob/main/packages/terra-graphs-docs/docs/controls/Panning.md)                                                                                                                                                     |
