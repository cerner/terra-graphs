...
See [Graph](../getting-started/graph-core/Documentation/Graph) for more details.
...
- ### Axis Info Row
    ...
    | shape          | object   | no       | {}                                                                                             | svg represented as json, which got transpiled from `@cerner/svg-to-carbon`. See[Shapes](../README.md#Shapes)    |
