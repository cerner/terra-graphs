...
Check [Graph](../getting-started/graph-core/Documentation/Graph) for graph configuration properties.
...
Refer [Graph](../getting-started/graph-core/Documentation/Graph) for graph configuration properties.
...
| ------------- | -------- | -------- | ------------------ | -------------------------------------------------------------------------------------------------------------------- |
| key           | string   | yes      | -                  | A unique `id` to identify the dataset. Adding two datasets with the same `key`.                                      |
