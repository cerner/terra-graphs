...
| color         | string           | no       | `COLORS.BLACK`       | Color for the data points. Can be a hex value (`#ffffff`) or a constant from [Colors](../GettingStarted.a/GraphCore/Documentation/Colors).   |
...
| shape         | string           | no       | `SHAPES.DARK.CIRCLE` | Shape for representing the data points. Can be a constant from [shapes](../GettingStarted.a/GraphCore/Documentation/Shapes) or a custom SVG. |
