...
| color         | string           | no       | `COLORS.BLACK`       | Color for the data points. Can be a hex value (`#ffffff`) or a constant from [Colors](../getting-started/graph-core/documentation/Colors).   |
...
| shape         | string           | no       | `SHAPES.DARK.CIRCLE` | Shape for representing the data points. Can be a constant from [shapes](../getting-started/graph-core/documentation/Shapes) or a custom SVG. |
