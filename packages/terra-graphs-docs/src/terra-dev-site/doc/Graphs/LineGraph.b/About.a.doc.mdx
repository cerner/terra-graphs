...
Check [Graph](../GettingStarted/GraphCore/Documentation/Graph.md) for graph configuration properties.
...
Refer [Graph](../GettingStarted/GraphCore/Documentation/Graph.md) for graph configuration properties.
