...
| color         | string   | no       | `COLORS.BLUE` | Color for the data points. Can be a hex value (`#ffffff`) or a constant from [Colors](../getting-started/graph-core/documentation/Colors). |
