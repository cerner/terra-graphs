...
*/
let graphConfig = utils.deepClone(getBarPanningConfig('#BarPanningDynamicData'));
...
const BarPanningExample = () => {
  ...
  return (
    <React.Fragment>
      ...
      <BarGraph graphID="BarPanningDynamicData" graphConfig={graphConfig} dataset={[dataset]} panData={newDataset} />
    </React.Fragment>
  );
};
