 ...
 */
const areWeightsDefined = (dataTarget) => (utils.isDefined(dataTarget.weight)
 ...
 */
const loadInput = (inputJSON) => new BubbleConfig().setInput(inputJSON).validateInput().clone()
  .getConfig();
