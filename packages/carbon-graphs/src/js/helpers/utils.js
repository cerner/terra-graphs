 ...
 */
const hasValue = (dict, value) => Object.keys(dict).some((o) => dict[o] === value);
/**
 ...
 * @returns {boolean} if not undefined or null return Number, 0 otherwise
 */
const isBoolean = (n) => typeof n === 'boolean' && !Number.isNaN(n);
/**
 ...
 */
const isEqual = (a, b) => (isDate(a) || isDateInstance(a)
