...
describe('Gantt - Unload', () => {
  ...
  let secondaryContent = utils.deepClone(getData());
  let tertiaryContent = utils.deepClone(getData());
  ...
  it('Unloads content correctly with different heights', () => {
    ...
    secondaryContent = utils.deepClone(getData());
    secondaryContent.key = 'uid_2';
    tertiaryContent = utils.deepClone(getData());
    tertiaryContent.key = 'uid_3';
