...
export const DEFAULT_HEIGHT = constants.TIMELINE_HEIGHT
 ...
 * @returns {object} input JSON
 */
export const getData = (values, isDefaultColor = true, isDefaultShape = true) => utils.deepClone({
  key: 'uid_1',
  label: {
    display: 'Timeline A',
  },
 ...
 */
export const fetchAllElementsByClass = (cls) => document.querySelectorAll(`.${cls}`);
