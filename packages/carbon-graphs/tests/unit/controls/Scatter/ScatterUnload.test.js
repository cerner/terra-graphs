...
describe.skip('Scatter - Unload', () => {
  ...
  describe('on Unload', () => {
    ...
    it('returns the scatter instance', async () => {
    ...
    it('removes the legend from graph', () => {
      const graphLegend = fetchElementByClass(scatterGraphContainer,
        styles.legend);
      const scatterLegendItem = fetchElementByClass(scatterGraphContainer, styles.legendItem);
  ...
  describe('Removes label shape from label container', () => {
    ...
    beforeEach(() => {
      ...
      scatterPrimary = new Scatter(getInput(valuesDefault, true, true, true));
