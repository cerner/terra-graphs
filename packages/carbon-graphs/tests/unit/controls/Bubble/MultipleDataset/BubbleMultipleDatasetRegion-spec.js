...
import { BubbleMultipleDataset } from '../../../../../src/main/js/controls/Bubble';
import {
  getXAxisWidth,
  getXAxisXPosition,
...
describe('Bubble Multiple Dataset - Region', () => {
  ...
  describe('On load', () => {
    describe('Ideally', () => {
      beforeEach(() => {
        ...
        bubble = new BubbleMultipleDataset(data);
    ...
    it('Hides all the regions if graph has more than 1 data-set', () => {
      ...
      bubble = new BubbleMultipleDataset(data);
      const bubbleContent = new BubbleMultipleDataset(secondaryInput);
      graphDefault.loadContent(bubble);
  ...
  describe('On legend item hover', () => {
    describe('When single-bubble', () => {
      ...
      beforeEach(() => {
        ...
        bubblePrimary = new BubbleMultipleDataset(inputPrimary);
  ...
  describe('Check if region same for multibubble with same dataset', () => {
    ...
    it('Hides region if one or more is missing', () => {
      ...
      bubbleThird = new BubbleMultipleDataset(inputTertiary);
