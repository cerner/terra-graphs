...
describe('Bubble Multiple Dataset', () => {
  ...
  describe('When constructed', () => {
    ...
    it('throws error when no input is provided', () => {
      expect(() => {
        graphDefault.loadContent(new BubbleMultipleDataset());
    ...
    it('throws error when invalid input is provided', () => {
      expect(() => {
        graphDefault.loadContent(
          new BubbleMultipleDataset({ dummy: 'dummy' }),
        );
    ...
    it('throws error when no values are provided', () => {
      expect(() => {
        graphDefault.loadContent(
          new BubbleMultipleDataset(getInput(undefined, false, false)),
        );
