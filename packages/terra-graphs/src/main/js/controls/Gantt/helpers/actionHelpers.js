 ...
 * @returns {undefined} - returns nothing
 */
const loadActions = (graphContext, trackPathSVG, trackLabel, gantt) => gantt.actions.forEach((a, i) => {
  drawDataPoints(
    graphContext.scale,
    graphContext.config,
    trackPathSVG,
 ...
 */
const unloadActions = (graphContext, trackPathSVG) => trackPathSVG.selectAll(`g.${styles.currentPointsGroup}`).remove();
