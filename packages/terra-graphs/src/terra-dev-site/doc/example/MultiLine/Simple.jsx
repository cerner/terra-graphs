...
export default () => <LineGraph graphID="multiLine" graphConfig={axisData} dataset={[data, data1, data2, data3, data4, data5, data6]} timeout={[0, 750, 750*2, 750*3, 750*4, 750*5, 750*6]} />;
