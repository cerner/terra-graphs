Terra.describeViewports(' PieCharts', ['tiny', 'medium', 'large'], () => {
  ...
  it('validates Pie custom legend placement graph container', () => {
    browser.url('/raw/tests/terra-graphs-docs/graphs/pie-chart/custom-legend-placement');
  ...
  it('validates Pie reduced padding graph container', () => {
    browser.url('/raw/tests/terra-graphs-docs/graphs/pie-chart/graph-and-legend-padding-reduced');
