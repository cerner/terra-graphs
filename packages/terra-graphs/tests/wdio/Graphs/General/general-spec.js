Terra.describeViewports('General', ['tiny', 'medium', 'large'], () => {
  describe('Axes', () => {
    it('validates datetime bucket graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/axes/datetime-bucket');
      Terra.validates.screenshot('datetime_bucket', { selector: '.carbon-graph-container' });
    });

    it('validates label hidden graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/axes/label-hidden');
    ...
    it('validates static x-axis ticks graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/axes/static-x-axis-ticks');
    ...
    it('validates supress tick values trailing zero graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/axes/suppress-Tick-Value-Trailing-Zero');
    ...
    it('validates x-axis alternate locale graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/axes/x-axis-alternate-locale');
    ...
    it('validates x-axis hidden graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/axes/x-axis-hidden');
    ...
    it('validates x-axis orientation top graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/axes/x-axis-orientation-top');
    ...
    it('validates x-axis ticks formatted graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/axes/x-axis-ticks-formatted');
    ...
    it('validates Y-axis hidden graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/axes/y-axis-hidden');
  ...
  describe('Grid', () => {
    it('validates horizontal grid hidden graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/grid/horizontal-grid-hidden');
    ...
    it('validates vertical grid hidden graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/grid/vertical-grid-hidden');
  ...
  describe('Legend', () => {
    it('validates legend hidden graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/legend/legend-hidden');
      Terra.validates.screenshot('legend_hidden', { selector: '.carbon-graph-container' });
    });

    it('validates legend item disable graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/legend/legend-item-disable');
    ...
    it('validates legend with legend options graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/legend/line-with-legend-option');
  ...
  describe('Other', () => {
    it('validates background color graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/other/background-color');
      Terra.validates.screenshot('background_color', { selector: '.carbon-graph-container' });
    });

    it('validates no data graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/other/no-data');
  ...
  describe('Legend', () => {
    it('validates custom legend placement graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/padding/custom-legend-placement');
    ...
    it('validates graph and legend padding reduced graph container', () => {
      browser.url('/raw/tests/terra-graphs/graphs/general/padding/graph-and-legend-padding-reduced');
