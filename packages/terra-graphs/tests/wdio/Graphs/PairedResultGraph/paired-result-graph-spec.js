Terra.describeViewports('PairedResultGraph ', ['tiny', 'medium', 'large'], () => {
  describe('Basic paired result graph', () => {
    it('validates legend item disable graph container', () => {
      browser.url('/raw/tests/terra-graphs-docs/graphs/paired-result/basic-paired-result-graphs/legend-item-disable');
    ...
    it('validates simple paired result graph container', () => {
      browser.url('/raw/tests/terra-graphs-docs/graphs/paired-result/basic-paired-result-graphs/simple-paired-result');
      Terra.validates.screenshot('simple_paired_result', { selector: '.carbon-graph-container' });
    });

    it('validates timeseries graph container', () => {
      browser.url('/raw/tests/terra-graphs-docs/graphs/paired-result/basic-paired-result-graphs/timeseries');
    ...
    it('validates timeseries with dateline graph container', () => {
      browser.url('/raw/tests/terra-graphs-docs/graphs/paired-result/basic-paired-result-graphs/timeseries-with-dateline');
    ...
    it('validates timeseries with eventline graph container', () => {
      browser.url('/raw/tests/terra-graphs-docs/graphs/paired-result/basic-paired-result-graphs/timeseries-with-eventline');
      Terra.validates.screenshot('timeseries_with_eventline', { selector: '.carbon-graph-container' });
    });

    it('validates y2-axis graph container', () => {
      browser.url('/raw/tests/terra-graphs-docs/graphs/paired-result/basic-paired-result-graphs/y-2-axis');
  ...
  describe('Criticality', () => {
    it('validates criticality multiple graph container', () => {
      browser.url('/raw/tests/terra-graphs-docs/graphs/paired-result/Criticality/multiple-paired-result');
    ...
    it('validates criticality simple graph container', () => {
      browser.url('/raw/tests/terra-graphs-docs/graphs/paired-result/Criticality/simple-paired-result');
  ...
  describe('Regions', () => {
    it('validates simple region graph container', () => {
      browser.url('/raw/tests/terra-graphs-docs/graphs/paired-result/regions/simple');
      Terra.validates.screenshot('region_simple', { selector: '.carbon-graph-container' });
    });

    it('validates value region graph container', () => {
      browser.url('/raw/tests/terra-graphs-docs/graphs/paired-result/regions/value-region');
      Terra.validates.screenshot('value_region', { selector: '.carbon-graph-container' });
    });

    it('validates multiple region graph container', () => {
      browser.url('/raw/tests/terra-graphs-docs/graphs/paired-result/regions/multiple-paired-result');
