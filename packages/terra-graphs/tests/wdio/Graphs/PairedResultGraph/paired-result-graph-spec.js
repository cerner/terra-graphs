Terra.describeViewports('PairedResultGraph ', ['tiny', 'medium', 'large'], () => {
  describe('Basic paired result graph', () => {
    it('validates legend item disable graph container', () => {
      ...
      Terra.validates.screenshot('legend_item_disable');
    });
    ...
    it('validates simple paired result graph container', () => {
      ...
      Terra.validates.screenshot('simple_paired_result');
    });
  ...
  describe('Criticality', () => {
    it('validates criticality multiple graph container', () => {
      ...
      Terra.validates.screenshot('criticality_multiple_paired_result');
    });
    ...
    it('validates criticality simple graph container', () => {
      ...
      Terra.validates.screenshot('criticality_simple_paired_result');
    });
  });
  ...
  describe('Regions', () => {
    it('validates simple region graph container', () => {
      ...
      Terra.validates.screenshot('region_simple');
    });
    ...
    it('validates multiple region graph container', () => {
      ...
      Terra.validates.screenshot('multiple_region');
    });
    ...
    describe('when hovered on multiple line region legends', () => {
      ...
      it('validates graph container when hovered on first dataset high', () => {
        element[0].moveTo();
        Terra.validates.screenshot('multiple_region_hovered_on_first_data_high');
      });
      it('validates graph container when hovered on first dataset Low', () => {
        element[2].moveTo();
        Terra.validates.screenshot('multiple_region_hovered_on_first_data_low');
      });
      it('validates graph container when hovered on second dataset high', () => {
        element[3].moveTo();
        Terra.validates.screenshot('multiple_region_hovered_on_second_data_high');
      });
      it('validates graph container when hovered on second dataset low', () => {
        element[5].moveTo();
        Terra.validates.screenshot('multiple_region_hovered_on_second_data_low');
      });
    });
    ...
    describe('Reflow', () => {
      ...
      describe('Dynamic data', () => {
        ...
        it('validates panning left', () => {
          ...
          panningBtn.click();
          Terra.validates.screenshot('paired_result_dynamic_data_panning_left_1');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_dynamic_data_panning_left_2');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_dynamic_data_panning_left_3');
        });
        it('validates panning right', () => {
          panningBtn = $('.button-pan-right');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_dynamic_data_panning_right_1');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_dynamic_data_panning_right_2');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_dynamic_data_panning_right_3');
        });
      });
      describe('Dynamic eventline', () => {
        ...
        it('validates panning left', () => {
          panningBtn = $('.button-pan-left');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_dynamic_eventline_panning_left_1');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_dynamic_eventline_panning_left_2');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_dynamic_eventline_panning_left_3');
        });
        it('validates panning right', () => {
          panningBtn = $('.button-pan-right');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_dynamic_eventline_panning_right_1');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_dynamic_eventline_panning_right_2');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_dynamic_eventline_panning_right_3');
        });
      });
      describe('Multiple Datasets', () => {
        ...
        it('validates panning left', () => {
          panningBtn = $('.button-pan-left');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_multiple_datasets_panning_left_1');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_multiple_datasets_panning_left_2');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_multiple_datasets_panning_left_3');
        });
        it('validates panning right', () => {
          panningBtn = $('.button-pan-right');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_multiple_datasets_panning_right_1');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_multiple_datasets_panning_right_2');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_multiple_datasets_panning_right_3');
        });
      });
      describe('Simple', () => {
        beforeEach(() => {
        ...
        it('validates panning left', () => {
          panningBtn = $('.button-pan-left');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_simple_panning_left_1');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_simple_panning_left_2');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_simple_panning_left_3');
        });
        it('validates panning right', () => {
          panningBtn = $('.button-pan-right');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_simple_panning_right_1');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_simple_panning_right_2');
          panningBtn.click();
          Terra.validates.screenshot('paired_result_simple_panning_right_3');
        });
      });
    });
  });
