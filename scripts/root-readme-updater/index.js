...
const packageListing = packages.map(component => `| [${component}](https://github.com/cerner/terra-graphs/tree/main/packages/${component}) | [![NPM version](https://badgen.net/npm/v/${component})](https://www.npmjs.org/package/${component}) | ![Stable](https://badgen.net/badge/status/Stable/green) | [![${component}](https://badgen.net/david/dep/cerner/terra-graphs/packages/${component})](https://david-dm.org/cerner/terra-graphs?path=packages/${component}) |`);
